...
const ProfileIcon = '/assets/images/logo.png';
    ...
    <>
          ...
          <div className={styles.headeralignment}>
            <div className={styles.leftcontent}>
              ...
              <div className={styles.menu}>
                ...
                <a onClick={() => document.getElementById('#services').scrollIntoView()}>Knowledge</a>
      ...
      <div className={mobileMenu ? classNames(styles.mobileHeader, styles.mobileheaderShow) : classNames(styles.mobileHeader, styles.headerHidden)}>
        ...
        <div className={styles.mobileBody}>
          <a onClick={() => {document.getElementById('#home').scrollIntoView(); setMobileMenu(false)}}>About Me</a>
          <a onClick={() => {document.getElementById('#journey').scrollIntoView(); setMobileMenu(false)}}>My Journey</a>
          <a onClick={() => {document.getElementById('#portfolio').scrollIntoView(); setMobileMenu(false)}}>Portfolio</a>
          <a onClick={() => {document.getElementById('#services').scrollIntoView(); setMobileMenu(false)}}>Knowledge</a>
          <a onClick={() => {document.getElementById('#contact').scrollIntoView(); setMobileMenu(false)}}>Contact Me</a>
          <div className={styles.rightcontent}>
            <div>
              <img src={LinkdinIcon} alt="LinkdinIcon" title="LinkedIn" onClick={() => handleClick("https://www.linkedin.com/in/vandan-khamkar-525aa8144/")} />
            </div>
